...
return [
    'permissions' => [
        ...
        'user_create' => 'Permet à l\'utilisateur de créer de nouveaux comptes d\'utilisateur pour le serveur.',
        ...
        'allocation_read' => 'Permet d\'accéder aux pages de gestion des allocations du serveur.',
        ...
        'database_update' => 'Autorise un utilisateur à apporter des modifications à une base de données. Si l\'utilisateur n\'a pas non plus l\'autorisation "Afficher le mot de passe", il ne pourra pas modifier le mot de passe.',
        ...
        'schedule_create' => 'Permet à un utilisateur de créer une nouvelle planification pour le serveur.',
        'schedule_read' => 'Permet à un utilisateur de créer un nouveau programme',
        'schedule_update' => 'Permet à un utilisateur d\'apporter des modifications à une planification de serveur existante.',
        'schedule_delete' => 'Permet à un utilisateur de supprimer une planification pour le serveur.',
    ],
];
